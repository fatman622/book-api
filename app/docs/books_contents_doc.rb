  ...
  description <<-EOS
    ...
    Is used for show books content
      Is used for auth
        ...
        curl -v localhost:5000/api/v1/books_contents -X GET -H 'Content-Type: application/json' -H 'access-token: lM_sZKwvk5yOSwkmsHC-BQ' -H 'client: lvLMUIVaNWrx9nTe1LmYIw' -H "uid: olegbaby@gmail.com"
